  ...
  return (
    <>
      <div className="container mx-auto px-4 md:px-8 bg-gray-900 min-h-screen rounded-2xl shadow-2xl my-8 p-6 md:p-12 border border-gray-800">
        ...
        <div className="grid grid-cols lg:grid-cols-2 gap-1">
          ...
          <div className="flex flex-col justify-between">
            ...
            <h2 className="text-xl font-bold text-gray-200 mb-2 border-b border-e-orange pb-2 flex items-center space-x-2">
            ...
            <ul
              className="space-y-3 text-gray-300 p-4 bg-gray-800 rounded-xl border border-gray-700
            "
            >
