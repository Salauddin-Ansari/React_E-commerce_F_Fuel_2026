  ...
  return (
    <>
      <div className="container mx-auto md:px-8 pt-12">
        <div className="p-12 bg-gray-900 rounded-3xl shadow-2xl max-w-2xl mx-auto text-center mt-12 border-green-700 text-white">
          <CheckCircle className="w-24 h-24 text-green-500 mx-auto mb-6 drop-shadow-lg" />
          <h2 className="text-4xl font-extrabold text-white mb-4"></h2>
          <p className="text-lg text-gray-300 mb-6">
            Your transaction is complete . A confirmation email sent to your
            account.
          </p>
          <div className="p-6 bg-green-900/50 border border-green-700 rounded-xl font-mono text-left inline-block text-green-300 text-sm">
